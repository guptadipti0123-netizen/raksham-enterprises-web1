  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 transition-all duration-300">
      ...
      <nav className={`transition-all duration-200 ${
        ...
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6">
          <div className="flex items-center justify-between gap-2">
            ...
            <Link to="/" className="flex items-center space-x-2.5 flex-shrink-0 group">
              <div className="w-10 h-10 rounded-lg overflow-hidden bg-white border border-slate-200 p-0.5 flex items-center justify-center shadow-xs group-hover:border-gold-500 transition-colors flex-shrink-0">
                <img 
              ...
              <div className="flex flex-col text-left">
                <span className="text-base sm:text-lg font-extrabold tracking-tight text-slate-900 leading-none group-hover:text-gold-700 transition-colors whitespace-nowrap">
                  <span className="text-gold-600 font-black">RAKSHAM</span> ENTERPRISES
                </span>
                <span className="text-[9px] uppercase tracking-wider text-slate-500 font-semibold mt-0.5 whitespace-nowrap">
            ...
            {/* Right Header Action Buttons (Minimal & Clean) */}
            <div className="hidden lg:flex items-center space-x-2 flex-shrink-0">
              {/* Book Service / Repair Button */}
              <Link
                to="/service-request"
            ...
            {/* Mobile Menu & Quick Portal Button */}
            <div className="flex items-center space-x-2 lg:hidden">
              <Link
                to="/service-request"
                className="px-2 py-1.5 rounded-lg bg-gold-50 border border-gold-300 text-gold-900 text-xs font-bold flex items-center space-x-1"
              >
                <Wrench className="w-3.5 h-3.5 text-gold-700" />
                <span>Service</span>
              </Link>

              <Link
                to={userRole ? (userRole === 'admin' ? '/admin/dashboard' : '/customer/dashboard') : '/login'}
                className="px-2.5 py-1.5 rounded-lg bg-slate-900 text-white text-xs font-bold flex items-center space-x-1"
              >
              ...
              <button
                ...
                className="p-2 rounded-lg bg-slate-100 border border-slate-200 text-slate-700 hover:text-gold-600 focus:outline-none"
        ...
        {isMobileMenuOpen && (
          <div className="lg:hidden bg-white border-b border-slate-200 px-4 pt-3 pb-6 space-y-3 shadow-lg animate-fadeIn">
            <div className="flex flex-col space-y-1">
                ...
                return (
                  <Link
                    ...
                    className={`px-3 py-2.5 rounded-xl text-xs font-bold transition-colors ${
                      isActive ? 'bg-gold-50 text-gold-700' : 'text-slate-700 hover:bg-slate-50'
                    }`}
                  >
                    {link.name}
                  </Link>
              ...
              <Link
                to="/login"
                className="px-3 py-2.5 rounded-xl text-xs font-bold text-gold-800 bg-gold-50 border border-gold-200 flex items-center space-x-2"
              >
            ...
            <div className="pt-3 border-t border-slate-100 grid grid-cols-2 gap-2">
              <a
                ...
                className="flex items-center justify-center space-x-1.5 py-2.5 rounded-xl bg-slate-100 text-slate-800 text-xs font-bold"
              >
              ...
              <a
                ...
                className="flex items-center justify-center space-x-1.5 py-2.5 rounded-xl bg-emerald-50 text-emerald-800 border border-emerald-200 text-xs font-bold"
              >
              ...
              <button
                ...
                className="col-span-2 py-3 rounded-xl bg-gold-500 text-white font-bold text-xs shadow-gold-soft text-center"
              >
