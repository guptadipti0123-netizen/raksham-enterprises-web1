...
import { Phone, Mail, MapPin, MessageSquare, ChevronRight, FileCheck, ShieldCheck } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="pt-2">
              ...
              >
                ...
                <span>Verify CCTV Service Report</span>
              </Link>
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs">
              ...
              <li><Link to="/cctv-amc" className="hover:text-gold-400 transition-colors">CCTV AMC Plans</Link></li>
              ...
              <li><Link to="/faq" className="hover:text-gold-400 transition-colors">SEO FAQs</Link></li>
        ...
        <div className="pt-6 border-t border-slate-800 space-y-2">
          ...
          <div className="flex flex-wrap gap-2 text-[11px] text-slate-500">
            {MUMBAI_LOCATIONS.map((loc, idx) => (
              <Link key={loc.name} to="/service-areas" className="hover:text-gold-400">
